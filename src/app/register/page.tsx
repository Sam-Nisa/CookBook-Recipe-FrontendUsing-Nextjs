  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center py-4 px-8 relative overflow-hidden bg-[#FAF8F5] font-sans">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="/register-bg-ingredients.png"
      ...
      <div className="relative z-10 w-full max-w-lg bg-white rounded-[32px] shadow-2xl p-8 sm:p-10 border border-[#F0EAE1] transform transition-all duration-300">
        ...
        <div className="mb-6 text-center">
          ...
          <p className="text-xs text-[#8E7E65] mt-1 font-medium">
            Join the hearth of home cooking
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-start mt-1">
            <input
              ...
              className="mt-1 h-4.5 w-4.5 accent-[#E07E1B] border-[#F0EAE1] rounded text-[#E07E1B] focus:ring-[#E07E1B] cursor-pointer"
            />
            <label
              htmlFor="agree-terms"
              className="ml-2.5 text-xs text-[#8E7E65] leading-snug mt-1 cursor-pointer select-none"
            >
              I agree to the{" "}
              <Link
                href="/terms"
